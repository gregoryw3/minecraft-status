//
//  Minecraft_Server_Status_iOS_Widget.swift
//  Minecraft Server Status iOS Widget
//
...
struct Minecraft_Server_Status_iOS_WidgetEntryView : View {
...
@main
struct Minecraft_Server_Status_iOS_Widget: Widget {
    let kind: String = "Minecraft_Server_Status_iOS_Widget"

    var body: some WidgetConfiguration {
        IntentConfiguration(kind: kind, intent: ConfigurationIntent.self, provider: Provider()) { entry in
            Minecraft_Server_Status_iOS_WidgetEntryView(entry: entry)
        }
...
struct Minecraft_Server_Status_iOS_Widget_Previews: PreviewProvider {
    static var previews: some View {
        Minecraft_Server_Status_iOS_WidgetEntryView(entry: SimpleEntry(date: Date(), configuration: ConfigurationIntent()))
